...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      <main className="flex-1 w-full max-w-app mx-auto px-6 py-6 pb-24">
        {children}
      </main>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-surface border-t border-border" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        <div className="max-w-app mx-auto flex items-center justify-around py-2">
          ...
          <Link to="/expenses" className={`flex flex-col items-center gap-1 p-2 ${active('/expenses')}`}>
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <Link
            to="/add-expense"
            className="w-12 h-12 bg-btn rounded-full flex items-center justify-center -mt-4 shadow-[0_2px_8px_rgba(0,0,0,0.15)]"
          >
          ...
          <Link to="/settle-up" className={`flex flex-col items-center gap-1 p-2 ${active('/settle-up')}`}>
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <Link to="/settings" className={`flex flex-col items-center gap-1 p-2 ${active('/settings')}`}>
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
